...
private:
            ...
            const std::vector<VkSurfaceFormatKHR>& availableFormats)
    {
        ...
        // TODO we could do tanking as we did for another thing, but meh
    ...
    void createGraphicsPipeline()
    {
        ...
        vertShaderStageInfo.pSpecializationInfo = nullptr; //set const calues
        ...
        fragShaderStageInfo.pSpecializationInfo = nullptr; //set const calues
        ...
        // no vertex buffers, data in shader
    ...
    void transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
    {
        ...
        endSingleCommands(commandBuffer, transferCommandPool);
    }
    ...
    void endSingleCommands(VkCommandBuffer commandBuffer, VkCommandPool& pool)
    {
